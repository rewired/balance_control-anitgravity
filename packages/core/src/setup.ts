...
import { normalizeGameConfig, hashState, assemblePacks, getPublicSurface } from '@balance-control/game';
import { coreUpdateStats } from './engine/state';
...
export const SetupGame = ({ ctx, setupData }: { ctx: Ctx, setupData?: unknown }): GameState => {
    ...
    coreUpdateStats(G, normalizedCtx);
