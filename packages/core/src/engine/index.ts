...
import { withReplaySink } from './replay';
...
export const CorePack: EnginePackDefinition = {
    ...
    setupGame: (ctx: any, setupData: unknown) => SetupGame({ ctx, setupData }),
    turn: coreRootTurn,
    endIf: coreEndIf,
    playerView: buildCorePlayerView,
    enumerateIntents: coreEnumerateIntents,
    updateStats: coreUpdateStats,
    wrapMovesForReplay: withReplaySink,
};

export { withReplaySink, emitReplaySystemRecord, projectReplayCheckpointSummary } from './replay';
