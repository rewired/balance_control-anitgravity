...
describe('Replay NDJSON verifier v2', () => {
    ...
    function baseRecords(): ReplayNdjsonRecord[] {
        return [
            ...
            { recordType: 'checkpoint.turnEnd', stateHash: 'x' as any },
    ...
    it('replays strict action sequence and returns deterministic final hash', () => {
        ...
        records[3] = { recordType: 'checkpoint.turnEnd', stateHash: verifyReplayRecords([records[0], records[1], records[2], { recordType: 'footer', totalActions: 1 }]).finalStateHash } as any;
